...
- 🔗 **Obtener link del reproductor**: genera una URL pública que abre **solo el reproductor** (sin el formulario ni las herramientas de gestión), con título, tira de miniaturas y controles completos. Ideal para enviarlo a alguien que quiere ver y navegar la playlist.
- 🖥️ **Botón de pantalla completa "limpia" sobre el video/imagen**: el pequeño botón 🔗 en la esquina del reproductor genera un link **público** distinto: abre directo en un visor minimalista, a pantalla completa, sin título, sin barra de controles, sin miniaturas ni pie de página — solo el video u imagen ocupando toda la pantalla. Un clic copia ese link al portapapeles (✅ de confirmación). Junto a él, el botón ⛶ activa la pantalla completa real del navegador; ambos botones viven dentro del recuadro del video, así que **siguen visibles incluso en pantalla completa real**.
